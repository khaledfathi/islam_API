        ...
        <div>
            <form action="{{ route('user.update') }}" method="post" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <textarea style="resize:none;vertical-align:middle" name="address" id="" cols="30" rows="5">{{$record->address}}</textarea>
                </div>
                ...
                <div>
                    @if ($record->image)
                        ...
                        <img style="vertical-align:middle" src="{{ asset($record->image) }}" alt="user image" width=100
                            height=100>
                    @endif
                </div>
                <div>
